...
public enum SQLQuery {
    ...
    ADD_ENTRY_TO_DATABASE("INSERT INTO `%DATABASE_PATH%`.`%TABLE_NAME_STANDARD%` (`user_uuid`, `user_name`, `user_first_seen`, `user_last_seen`, `user_discord_id`, `user_forum_id`, `user_total_onlinetime`, `user_language_selected`, `user_last_cached_IP`) VALUES (`?`, `?`, `?`, `?`, `?`, `?`, `?`, `?`, `?`);"),
